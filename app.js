...
let incompleteTaskHolder = document.getElementById("todo-task");//ul of #incompleteTasks
let completedTasksHolder = document.getElementById("done-task");//completed-tasks
...
var bindTaskEvents = function (taskListItem, checkBoxEventHandler) {
    ...
    var checkBox = taskListItem.querySelector("input");
